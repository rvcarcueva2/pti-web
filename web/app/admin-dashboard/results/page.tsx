...
export default function CompetitionPage() {
  ...
  const columns = [
    { label: 'Competition', key: 'competition', minWidth: 'min-w-[150px]' },
    { label: 'Gold', key: 'gold', minWidth: 'min-w-[80px]' },
    { label: 'Silver', key: 'silver', minWidth: 'min-w-[80px]' },
    { label: 'Bronze', key: 'bronze', minWidth: 'min-w-[80px]' },
          ...
          <tbody>
            {filteredCompetitions.map((comp, index) => (
              ...
              >
                ...
                <td className="p-3 min-w-[80px]">{comp.bronze}</td>
                ...
                <td className="p-3 text-center w-[60px]">
                  <Image
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      router.push('/admin-dashboard/competitions/competition');
                    }}
